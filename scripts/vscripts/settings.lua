...
DEV_MODE = 0
REQUIRED_PUDGE_COUNT = 2 -- If there are less than the required number of actual pudge players, we will spawn in bots to fill the slots.
REQUIRED_CM_COUNT = 8 -- If there are less than the required number of actual CM players, we will spawn in bots to fill the rest of the slots.
HIDE_DURATION = 20
PRE_GAME_TIME = HIDE_DURATION
MAX_ALLOWED = DOTA_MAX_TEAM_PLAYERS
LOBBY_WAIT_TIME = 30

PUDGE_INIT_STUN_DURATION = 19
PUDGE_INIT_SIZE_SCALE = 0.75
PUDGE_KILL_SIZE_SCALING = 0.25
PUDGE_KILL_VISION_BONUS = 200
PUDGE_KILL_MOVE_SPEED_BONUS = 20
